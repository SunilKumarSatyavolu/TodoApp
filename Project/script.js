...
function createCard(task, date, time) {
  ...
  card.classList.add('card','col-mid-4','my-3');
...
let audio; // Make sure to declare the audio variable in the outer scope.
...
async function playNotificationSound() {
  try {
    ...
    audio = new Audio('COMCell_Message 1 (ID 1111)_BSB.wav');
    await audio.play();
  } catch (error) {
